...
function onloadCallback() {
    grecaptcha.render('faucetClaimCaptcha', {
        'sitekey' : '6LelhQoUAAAAAP5g23Zhg9fdSXyte1HN6kF3QlKH',
...
window.alert('Error: Multiply on win and/or loss are not numbers!');
    ...
    $(".login_button").click(function(){
        if(user.connected){
            ...
            window.location.href = "https://www.moneypot.com/oauth/authorize?app_id=2365&response_type=token&state=Meh&redirect_uri=http://wheel.btcpot.cf";
        }
    });
